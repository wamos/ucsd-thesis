...
% in your title.
\title{Accelerating Data Movement at Different Granularities in Data centers}
...
\begin{abstract}
  ...
  %
  \daronpon dynamically load balances and reroutes large scale requests of web and cache application on microsecond timescale. 
  %
  \daronpon prevents these requests stranded on busy servers with network congestion and long queuing delay to be processed.
  %
  \daronpon shows improvement on various service time characterizations of different applications 
  %
  ...
  %
  \dmx shows improvement on a series of benchmarks involving different application domains.
  %
  ...
  %
  \aurelia improves routing and transport based on current specification of CXL and shows performance improvement on machine learning and key-value store applications.
\end{abstract}
